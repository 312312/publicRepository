...
public class EnvironmenttPage extends BaseClass {

	@FindBy(xpath = "(//a[contains(text(),'Environemnt')])[1]")
	static WebElement environment;

	@FindBy(xpath = "//a[@title='View details for this environment']")
